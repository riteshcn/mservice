...
import pl.piomin.microservices.edge.model.UserInfo;
...
public class AuthenticationFilter extends ZuulFilter {
        ...
        try {
            restExchange =
                    restTemplate.exchange(
                            "http://auth-service/oauth/check_token/{token}",
                            HttpMethod.GET,
    ...
    public Object run() {
        ...
        if ( ctx.getRequest().getRequestURI().equals("/api/auth/oauth/token")){
            return null;
        }
